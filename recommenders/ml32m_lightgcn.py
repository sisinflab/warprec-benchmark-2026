...
dataset_name = "Movielens32M"
model_name = "LightGCN"
dataset_path = "../dataset/ml-32m/ratings.csv"
...
# Select MovieLens data size: 100k, 1m, 10m, 20m, or 32m
MOVIELENS_DATA_SIZE = '32m'
...
df.rename(columns={"userId": "userID", "movieId": "itemID"}, inplace=True)
