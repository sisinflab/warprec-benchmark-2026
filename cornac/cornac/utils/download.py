...
def cache(url, unzip=False, relative_path=None, cache_dir=None):
    ...
    """
    # For benchmarking, we use local files instead of downloading from the url
    return "../dataset/movielens-1m/ratings.csv"
    # return "../dataset/ml-32m/ratings.csv"
    # return "../dataset/netflix-prize-100m/ratings_processed.csv"
