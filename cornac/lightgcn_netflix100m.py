...
logger = LifecycleLogger("results/Netflix100M-LightGCN.txt")
...
lightgcn_1 = LightGCN(emb_size=64, num_epochs=2, learning_rate=0.001, num_layers=2)
lightgcn_2 = LightGCN(emb_size=128, num_epochs=2, learning_rate=0.001, num_layers=2)
lightgcn_3 = LightGCN(emb_size=256, num_epochs=2, learning_rate=0.001, num_layers=2)
lightgcn_4 = LightGCN(emb_size=64, num_epochs=2, learning_rate=0.001, num_layers=3)
lightgcn_5 = LightGCN(emb_size=128, num_epochs=2, learning_rate=0.001, num_layers=3)
lightgcn_6 = LightGCN(emb_size=256, num_epochs=2, learning_rate=0.001, num_layers=3)
