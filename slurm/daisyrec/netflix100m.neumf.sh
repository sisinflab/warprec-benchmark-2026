...
# Start the app
python tune.py --optimization_metric=ndcg --hyperopt_trail=6 --algo_name=neumf --dataset=nf-100m-custom --prepro=origin --topk=10 --fold_num=1 --epochs=2 --test_size=0.1 --val_size=0.001 --cand_num=18000 --gpu=0 --init_method=default --optimizer=adam --early_stop --loss_type=CL --test_method=rsbr --val_method=rsbr --sample_method=uniform --tune_pack='{"batch_size": [8192], "dropout": [0.1], "lr": [0.001], "factors": [64, 128, 256], "num_ng": [0, 1], "reg_1": [0.001], "reg_2": [0.001], "num_layers": [3]}'
