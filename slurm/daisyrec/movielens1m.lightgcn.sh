...
# Start the app
python tune.py --optimization_metric=ndcg --hyperopt_trail=6 --algo_name=lightgcn --dataset=ml-1m-custom --prepro=origin --topk=10 --fold_num=1 --epochs=10 --test_size=0.1 --val_size=0.001 --cand_num=4000 --gpu=0 --init_method=default --optimizer=adam --early_stop --loss_type=BPR --test_method=rsbr --val_method=rsbr --sample_method=uniform --tune_pack='{"batch_size": [8192], "lr": [0.001], "factors": [64, 128, 256], "num_ng": [1], "node_dropout": [0], "mess_dropout": [0], "reg_1": [0.001], "reg_2": [0.001], "num_layers": [2, 3]}'
